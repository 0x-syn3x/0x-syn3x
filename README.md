...
- **Alias**: blacksigil / 0x_syn3x  
- **Location**: Somewhere in cyberspace  
- **Specialties**: Binary reverse engineering • Exploit dev • Threat intel  
- **Current Obsession**: Linux kernel exploits • Firmware hacking  
- **Certifications**: None, just raw skill  
- **Contact**: [@yourhandle](https://twitter.com) | protonmail@0x-syn3x  
